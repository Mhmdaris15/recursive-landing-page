...
export const data = [
    ...
    key_features: [
      {
        ...
        description: "Browse digital menus and place orders directly from the app."
      },
      {
        title: "Table Reservations",
        description: "Book a table in advance with real-time availability checks."
      },
      {
        title: "Progressive Web App (PWA) Support",
        description: "Accessible via browser or mobile, no installation required."
      },
      {
    ...
    key_features: [
      {
        ...
        description: "Track the real-time location, route history, and operational status of each vehicle in your fleet."
      },
      {
        title: "Asset Management",
        description: "Keep accurate records of company assets, including vehicles, equipment, and other resources, with full lifecycle tracking."
      },
      {
        title: "User Management",
        description: "Define roles and manage access for different users across the system to ensure data security and accountability."
      },
      {
        title: "Driver Management",
        description: "Monitor driver performance, assign tasks, track driving behavior, and manage schedules and records."
      }
    ],
    benefits: [
      "Improves operational efficiency through real-time fleet visibility.",
      "Enhances asset utilization and maintenance planning.",
  ...
  },
  {
    id: "3",
    title: "Solivex",
    description: "Solivex is an AI-powered web platform designed to support students, digital nomads, and global learners in navigating new academic and social environments. With a sleek and intuitive interface, Solivex makes it easy to find tailored solutions and resources in real-time.",
    secondary_description: "Solivex uses artificial intelligence to analyze user behavior, preferences, and context, ensuring every search result is hyper-personalized — from mentorship opportunities to mental health support.", // Renamed from description2
    key_features: [
      {
        title: "Tutoring Network",
        description: "Discover verified tutors and study groups based on your academic goals and preferences."
      },
      {
        title: "Educational Guidance",
        description: "Receive AI-curated academic pathways and program recommendations."
      },
      {
        title: "Emotional Wellbeing",
        description: "Get matched with certified mental health resources and communities that support your journey."
      },
      {
        title: "Accommodation Finder",
        description: "Find trusted living spaces near campus or within your desired city zones."
      },
      {
        title: "City Orientation",
        description: "Navigate your new city with curated guides, tips, and maps — personalized by AI."
      },
      {
        title: "Community Events",
        description: "Stay in the loop with local events, workshops, and student-led meetups."
      }
    ],
    benefits: [],
    images1: Solivex,
